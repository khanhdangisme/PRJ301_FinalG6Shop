<%-- 
    Document   : shop
    Created on : Jun 20, 2025, 6:55:26 PM
    Author     : KhanhDang
--%>
        ...
        <div class="col-lg-3">
            ...
            <ul class="list-unstyled templatemo-accordion">
                <c:forEach var="cat" items="${categories}">
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="shop.jsp?category=${cat.id}">
                            ${cat.name}
                            <i class="fa fa-fw fa-chevron-circle-down mt-1"></i>
                        </a>
                        <!-- Optional: Nếu muốn show list version thì bạn có thể chèn thêm <ul> ở đây -->
                    </li>
                </c:forEach>
            </ul>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-inline shop-top-menu pb-3 pt-1">
                        ...
                        <li class="list-inline-item">
                            <a class="h3 text-dark text-decoration-none mr-3" href="#">iPhone</a>
                        </li>
                        <li class="list-inline-item">
                            <a class="h3 text-dark text-decoration-none" href="#">iPad</a>
                        </li>
                        <li class="list-inline-item">
                            <a class="h3 text-dark text-decoration-none" href="#">Macbook</a>
                        </li>
                    </ul>
                </div>
